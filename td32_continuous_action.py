...
"""
    ...
    qf1_target = QNetwork(envs,num_params).to(device)
    qf2_target = QNetwork(envs,num_params).to(device)
        ...
        if global_step > args.learning_starts:
            ...
            with torch.no_grad():
                ...
                def compute_actor_loss(params,buffers,data):
                    ...
                    actor_loss = -qf1(obs, action).mean()
            ...
            if global_step % args.policy_frequency == 0:
                ...
                actor_loss = -qf1(data.observations,pi).mean()
